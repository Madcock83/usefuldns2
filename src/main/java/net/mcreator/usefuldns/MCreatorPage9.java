...
public class MCreatorPage9 extends Elementsusefuldns.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorPage9(Elementsusefuldns instance) {
		super(instance, 177);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("page9"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 14, this.guiTop + 70, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Unobtainium Ingots", 96, 28, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 115, this.guiTop + 180, 44, 20, "Next", e -> {
		...
		if (buttonID == 0) {
			{
				...
				MCreatorOpenpage10.executeProcedure($_dependencies);
			}
		}
	}
