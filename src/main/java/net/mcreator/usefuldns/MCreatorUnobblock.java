...
public class MCreatorUnobblock extends Elementsusefuldns.ModElement {
	@ObjectHolder("usefuldns:unobblock")
	public static final Block block = null;

	public MCreatorUnobblock(Elementsusefuldns instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL).sound(SoundType.ANVIL).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(3)
