...
public class MCreatorDecablo extends Elementsusefuldns.ModElement {
	@ObjectHolder("usefuldns:decablo")
	public static final Block block = null;

	public MCreatorDecablo(Elementsusefuldns instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2f, 32f).lightValue(225).harvestLevel(2)
