...
public class MCreatorPage13 extends Elementsusefuldns.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorPage13(Elementsusefuldns instance) {
		super(instance, 185);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("page13"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 3, this.guiTop + 32, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Endpop [WIP]", 141, 32, -1);
			this.font.drawString("Right click to teleport to the end", 3, 166, -1);
			this.font.drawString("RIGHT NOW THIS IS TELEPORT YOU TO X200 & Z200", 2, 179, -1);
			this.font.drawString("MAKE SURE YOU CAN FLY OR YOU WILL DIE!", 2, 190, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 247, this.guiTop + 86, 44, 20, "Next", e -> {
		...
		if (buttonID == 0) {
			{
				...
				MCreatorOpenpage14.executeProcedure($_dependencies);
			}
		}
	}
