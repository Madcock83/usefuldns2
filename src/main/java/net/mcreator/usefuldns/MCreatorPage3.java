...
public class MCreatorPage3 extends Elementsusefuldns.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorPage3(Elementsusefuldns instance) {
		super(instance, 162);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("page3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 53, this.guiTop + 50, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Unobtainium ChestPlate", 110, 26, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 145, this.guiTop + 190, 44, 20, "Next", e -> {
		...
		if (buttonID == 0) {
			{
				...
				MCreatorOpenpage4.executeProcedure($_dependencies);
			}
		}
	}
