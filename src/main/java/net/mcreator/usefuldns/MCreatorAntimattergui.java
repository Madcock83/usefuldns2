...
public class MCreatorAntimattergui extends Elementsusefuldns.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorAntimattergui(Elementsusefuldns instance) {
		super(instance, 181);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 17, this.guiTop + 46, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Anti-matter Projector", 0, 1, -1);
			this.font.drawString("Place and right click with a Madbuck", 0, 10, -1);
			this.font.drawString("It will Dupe whatever is underneath", 0, 19, -1);
			this.font.drawString("Some blocks can NOT be Duped", 0, 26, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 191, this.guiTop + 10, 92, 20, "Main Menu", e -> {
		...
		if (buttonID == 0) {
			{
				...
				MCreatorOpenpage1.executeProcedure($_dependencies);
			}
		}
	}
