...
public class MCreatorPage11 extends Elementsusefuldns.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorPage11(Elementsusefuldns instance) {
		super(instance, 183);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("page11"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 4, this.guiTop + 21, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Random items", 113, 3, -1);
			this.font.drawString("Swiss Army Knife", 142, 29, -1);
			this.font.drawString("This acts as an Axe, Shovel, and Pickaxe", 4, 157, -1);
			this.font.drawString("Use it on vanilla ore to get a buff in drop counts", 5, 169, -1);
			this.font.drawString("Mining Iron ore with this will give you 3 raw iron", 4, 177, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 245, this.guiTop + 86, 44, 20, "Next", e -> {
		...
		if (buttonID == 0) {
			{
				...
				MCreatorOpenpage12.executeProcedure($_dependencies);
			}
		}
	}
