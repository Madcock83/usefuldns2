...
public class MCreatorUnobcrafter extends Elementsusefuldns.ModElement {
	@ObjectHolder("usefuldns:unobcrafter")
	public static final Block block = null;

	public MCreatorUnobcrafter(Elementsusefuldns instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3f, 10010f).lightValue(0).harvestLevel(2)
